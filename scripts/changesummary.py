...
class ChangeSummary:
    ...
    def _build_summary_message(self, api_name):
        """Returns a string containing the summary for a given api. The string
        returned will be in the format `chore(<api_name>): update the API`.

        args:
            api_name (str): The name of the api to include in the summary.
        """

        # Build the conventional commit string for the given API
